#!/bin/sh
# Guest-side benchmark — runs INSIDE ShellBox, measures with /proc/uptime
...
# (e.g. x86 ShellBox missing io_uring syscall used by Node 22) still produce C data.
...
# Each test wrapped in timeout so x86 ShellBox (missing io_uring syscall 425)
