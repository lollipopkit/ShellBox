#!/bin/bash
# ═══════════════════════════════════════════════════════════════════════
# ShellBox Unified Benchmark — Performance & Compatibility
#
# Usage:
...
#
# Runs assets/shellbench.sh INSIDE each ShellBox instance. The script
...
_md_shell_arm64_section() {
    local rows=("$@") prev=""
    {
        ...
        echo ""
        echo "> **Guest-side timing** — each test measured inside ARM64 ShellBox with"
...
main() {
    ...
    echo ""
    echo "═══════════════════════════════════════════════════════════════"
    echo "  ShellBox Unified Benchmark"
